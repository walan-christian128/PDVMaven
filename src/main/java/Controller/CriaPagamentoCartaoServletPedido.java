...
@WebServlet("/criaPagamentoCartaoServletPedido")
public class CriaPagamentoCartaoServletPedido extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (idEmpresaParam != null && !idEmpresaParam.isEmpty()) {
                ...
                int idPedido = dao.retornaUltimoPedido(); 
                ...
                PedidosParaAtualizar.setPagamentoPedido("PENDENTE"); 
                boolean inicializado = dao.atualizarPedidoOnline(idPedido, PedidosParaAtualizar); 
                
                if (inicializado) {
                    System.out.println("Venda " + idPedido + " inicializada com Status PENDENTE e Ref: " + PedidosParaAtualizar.getReferecialPedido());
                } else {
                    System.err.println("Falha ao inicializar a venda " + idPedido + ". Prosseguindo com o pagamento...");
                }
                ...
                PaymentCreateRequest paymentCreateRequest = PaymentCreateRequest.builder()
                        ...
                        .description("Pagamento via cartão - Pedido #" + idPedido)
                ...
                // =======================================================
                String novoStatusPedido = payment.getStatus(); 
                if (novoStatusPedido != null) {
                    String statusFormatado = novoStatusPedido.toUpperCase();
                    boolean sucessoAtualizacao = dao.atualizarStatuspedido(idPedido, statusFormatado); 
                    
                    if (sucessoAtualizacao) {
                        System.out.println("DB ATUALIZADO: Status da venda " + idPedido + " alterado para: " + statusFormatado);
                    } else {
                        System.err.println("DB FALHA: Não foi possível atualizar o status da venda " + idPedido + " no banco de dados.");
                    }
                }
                // =======================================================
