...
@WebServlet("/checkPaymentStatusServletPedido")
public class CheckPaymentStatusServletPedido extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public CheckPaymentStatusServletPedido() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String status = dao.getStatusPedidoPorId(orderId); 
